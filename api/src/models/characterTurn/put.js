...
export default async (params = {}, client) => {
    ...
    let data = getUpdateStatementKeys(params, CharacterTurn.checkQueryVariableType);

    const query = `UPDATE tracker.character_turn SET ${data.keyValuePairs} WHERE id=${id};`;
